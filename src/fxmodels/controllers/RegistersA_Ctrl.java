...
public class RegistersA_Ctrl implements Initializable {
    ...
    @FXML
    private TableColumn<RegisterObj,String> userColumn,dateColumn,objColumn,materialColumn,detectorColumn;
    ...
    public void initialize(URL url, ResourceBundle resources){
        ...
        if(!items.isEmpty()){
            ...
            for(int i=0; i<items.size(); i++){ vals[i] = items.get(i); }
    ...
    public void goBackA(ActionEvent ev){ Controllers.switchTo("../Menu.fxml", ev); }
